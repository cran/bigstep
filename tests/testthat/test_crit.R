test_that("bic and aic", {
  expect_true(bic(rss=10, n=50, k=5) < bic(rss=10, n=50, k=6))
  expect_error(bic(10, 0, 5), "n > 0 is not TRUE")
  expect_true(bic(rss=10, n=50, k=5) > aic(rss=10, n=50, k=6))
})

test_that("bic and mbic", {
  expect_true(bic(rss=10, n=50, k=5) < mbic(rss=10, n=50, k=5, p=50))
